...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .field input:focus,.field textarea:focus{border-color:#4f7cff;background:rgba(79,124,255,0.07);box-shadow:0 0 0 3px rgba(79,124,255,0.14)}
  .submit-btn{width:100%;padding:14px;border:none;border-radius:13px;background:linear-gradient(135deg,#4f7cff,#9b6dff);color:#fff;font-family:'Syne',sans-serif;font-size:.94rem;font-weight:700;letter-spacing:.05em;cursor:pointer;box-shadow:0 6px 30px rgba(79,124,255,0.3);transition:transform .18s,box-shadow .18s}
...
export default function Transfer() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // PIN exists → go to verify-pin with transfer payload
      navigate('/verify-pin', {
        state: {
          action: 'transfer',
