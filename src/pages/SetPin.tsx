...
const CSS = `
  ...
  *,*::before,*::after{
  ...
  .page-wrap{
    min-height:100vh;
    background:
      radial-gradient(ellipse at 20% 20%,rgba(251,191,36,0.07) 0%,transparent 50%),
      radial-gradient(ellipse at 80% 80%,rgba(79,124,255,0.06) 0%,transparent 50%),
      #080b12;
    display:flex;
